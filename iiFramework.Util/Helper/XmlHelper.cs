...
namespace iiFramework.Util
{
    public static class XmlHelper
    {
        ...
        /// <returns></returns>
        public static void Insert(XmlDocument xmlDocument, string node, string element, string attribute, string value)
        {
            /**************************************************
            * 使用示列:
        ...
        public static string Read(XmlDocument xmlDocument, string node, string attribute)
        {
            /**************************************************
             * 使用示列:
            ...
            {
                var selectSingleNode = xmlDocument.SelectSingleNode(node);
                value = string.IsNullOrEmpty(attribute)
        ...
        ///     读取数据
        /// </summary>
        /// <param name="path">路径,如："/Node"</param>
        /// <param name="node">节点</param>
        /// <param name="attribute">属性名，非空时返回该属性值，否则返回串联值</param>
        /// <returns>string</returns>
        ...
        /// <param name="path">路径</param>
        /// <param name="node">节点</param>
        /// <param name="nextNode">限制下一个节点名,为空则返回任意下一节点</param>
        /// <param name="attribute">属性名，非空时返回该属性值，否则返回串联值</param>
        /// <returns>string</returns>
        public static string ReadNext(XmlDocument xmlDocument, string node,string nextNode, string attribute, string nextNodeName = "")
        {
            var value = "";
            try
            {
                var selectSingleNode = xmlDocument.SelectSingleNode(node);
                var nextXmlNode = selectSingleNode.NextSibling;
                var finalNode = nextXmlNode.SelectSingleNode(nextNode);
                value = string.IsNullOrEmpty(attribute)
                    ? finalNode?.InnerText
                    : finalNode?.Attributes?[attribute].Value;
                if (!string.IsNullOrEmpty(nextNodeName) && nextXmlNode.Name != nextNodeName)
                {
                    value = "";
                }
            }
        ...
        /// 读取数据节点内部字符串
        /// </summary>
        /// <param name="path">路径,如："//Node/Element[@Attribute='Name']"</param>
        /// <param name="node">节点</param>
        /// <returns>string</returns>
        public static string ReadInnerXml(string path, string node)
        {
            var value = "";
            try
            {
                ...
                xmlDocument.Load(path);
                var selectSingleNode = xmlDocument.SelectSingleNode(node);
                value = selectSingleNode?.InnerXml;
            }
            catch (Exception exception)
            {
                Console.WriteLine("Error! " + exception.Message);
        ...
        /// <param name="node">节点</param>
        /// <returns>string</returns>
        public static string ReadOuterXml(string path, string node)
        {
            var value = "";
            try
            {
                ...
                xmlDocument.Load(path);
                var selectSingleNode = xmlDocument.SelectSingleNode(node);
                value = selectSingleNode?.OuterXml;
            }
            catch (Exception exception)
            {
                Console.WriteLine("Error! " + exception.Message);
        ...
        /// <summary>
        ///  读取xml的节点, xmlTextReader方式
        /// </summary>
        /// <param name="path">路径</param>
        /// <param name="nodeName">节点名称，如："node"</param>
        /// <param name="name">属性名称,如："attribute"</param>
        /// <returns></returns>
        ...
        /// <param name="value">值</param>
        /// <returns></returns>
        public static void Update(XmlDocument xmlDocument , string node, string attribute, string value)
        {
            /**************************************************
             * 使用示列:
        ...
        /// <param name="attribute">属性名，非空时返回该属性值，否则返回串联值</param>
        /// <param name="value">值</param>
        /// <param name="nextNodeName">限制下一节点名称</param>
        /// <returns>string</returns>
        public static void UpdateNext(XmlDocument xmlDocument, string node, string nextNode, string attribute,string value, string nextNodeName = "")
        {
            try
            {
                var selectSingleNode = xmlDocument.SelectSingleNode(node);
                var nextXmlNode = selectSingleNode.NextSibling;
                var finalNode = nextXmlNode.SelectSingleNode(nextNode);
                var xmlElement = (XmlElement)finalNode;
                if (string.IsNullOrEmpty(nextNodeName) ||  (!string.IsNullOrEmpty(nextNodeName) && nextXmlNode?.Name == nextNodeName))
                {
                    if (string.IsNullOrEmpty(attribute))
                    {
                        if (xmlElement != null) xmlElement.InnerText = value;

...
namespace iiFramework.Util
{
    ...
    public sealed class ScriptEngine : IDisposable
    {
        ...
        public class ScriptSite : IActiveScriptSite
        {
            public ScriptException LastException { get { return _LastException; } }

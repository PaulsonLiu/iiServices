...
namespace iiFramework.Util
{
    ...
    public class MachineInfoHelper
    {
        ...
        static MachineInfoHelper Instance;
        ...
        {
            if (Instance == null) Instance = new MachineInfoHelper();
            return Instance;
        }
